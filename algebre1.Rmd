...
Posons $P_0=(x_0,y_0,z_0)$ un point de la droite et $\overrightarrow{u}=[u_1,u_2,u_3]$ un vecteur directeur de la droite, notée $D$. La figure suivante nous aidera à trouver l'équation vectorielle de $D$.

```{tikz,echo=FALSE,out.width="50%",fig.align="center",fig.cap="Une droite de l'espace.",label="droite-R3",engine.opts="\\usepackage{pgfplots}"}
\begin{tikzpicture}
...
<!--chapter:end:08-droites-plans-espace.Rmd-->
