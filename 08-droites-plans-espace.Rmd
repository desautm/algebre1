...
(\#eq:position_plan_droite)
\end{align*}

L'équation \@ref(eq:position_plan_droite) possède une solution uniquement si le dénominateur est différent de zéro, c'est-à-dire si:
\begin{align*}
au_1+bu_2+cu_3 &\neq 0 \\
