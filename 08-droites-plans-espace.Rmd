...
\dfrac{-(a(x_0-x_1)+b(y_0-y_1)+c(z_0-z_1))}{au_1+bu_2+cu_3} &= t
(\#eq:position-relative-plan-droite)
\end{align*}

L'équation \@ref(eq:position-relative-plan-droite) possède une solution uniquement si le dénominateur est différent de zéro, c'est-à-dire si:
\begin{align*}
au_1+bu_2+cu_3 &\neq 0 \\
...
Nous pouvons représenter graphiquement ces trois situations comme à la figure
