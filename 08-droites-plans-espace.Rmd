...
```{tikz,echo=FALSE,fig.align="center",out.width="75%",fig.cap="La représentation de la distance entre un point et un plan.",label="distance-point-plan"}
\begin{tikzpicture}
\draw[very thick,blue,->,>=stealth] (1,1)--(1,3) node[above] {$\vec n$};
\draw[fill=blue,fill opacity=0.5] (-0.5,2)--(-3.5,-0.5)--(2,-0.5)--(5,2)--cycle;
...
```{tikz,echo=FALSE,fig.align="center",out.width="75%",fig.cap="La représentation de la distance entre une droite et un plan parallèles.",label="distance-droite-plan"}
\begin{tikzpicture}
\draw[very thick,blue,->,>=stealth] (1,1)--(1,3) node[above] {$\vec n$};
\draw[fill=blue,fill opacity=0.5] (-0.5,2)--(-3.5,-0.5)--(2,-0.5)--(5,2)--cycle;
\draw[very thick,green] (-1,2.5)--(4,2.5) node[right] {$D$};
...
```{tikz,echo=FALSE,fig.align="center",out.width="75%",fig.cap="La représentation de la distance entre deux plans parallèles.",label="distance-plan-plan"}
\begin{tikzpicture}
\draw[fill=blue,fill opacity=0.5] (-0.5,2)--(-3.5,-0.5)--(2,-0.5)--(5,2)--cycle;
\draw[very thick,red] (-1,0.5)--(1,2.5);
\draw[fill=red,fill opacity=0.5] (-0.5,3.25)--(-3.5,0.75)--(2,0.75)--(5,3.25)--cycle;
\draw[very thick,blue,->,>=stealth] (1,1)--(1,3.5) node[above] {$\vec n_1$};

\tikzstyle{mystyle}=[draw,circle,inner sep=1pt,fill]
\coordinate [mystyle,label=right:$R$] (R) at (1,1);
\coordinate [mystyle,label=above right:$Q$] (Q) at (1,2.5);
\coordinate [mystyle,label=left:$P$] (P) at (-1,0.5);
\coordinate [mystyle] (S) at (-0.75,2);
...
\draw[very thick,dashed] (P)--(R);
\draw[very thick,red,->,>=stealth] (S)--(-0.75,3.25) node[above] {$\vec n_2$};
\end{tikzpicture}
``` 
...
```{example}
INTERSECTION LIGNE-PLAN POUR VISION 3D...
```

## Les positions relatives de droites et de plans dans l'espace
