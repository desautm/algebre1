...
Soit une matrice $A_n$ et $p_A(t)$ son polynôme caractéristique.
  ...
  - Le coefficient de $t^{n-1}$ est égal à la trace de la matrice $-A$, c'est-à-dire $\text{tr}(-A)=-\text{tr}(A)$.
